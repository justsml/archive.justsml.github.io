...
var autoCloseHandle = null;
if (location.pathname !== '/') {
          autoCloseHandle = setInterval(autoCloseIfScrolled, 500);
}

function autoCloseIfScrolled() {
          var menuBtn = document.querySelector('.dl-trigger');
            var menu    = document.querySelector('.dl-menu');
              var body    = document.body;
                if (body.scrollTop > 80 && menu.classList.contains('dl-menuopen')) { 
                            menuBtn.click();
                                clearInterval(autoCloseHandle);
            }
}
